...
public abstract  class CellInfoManager {
       private int asu;
       private int bid;
       private int cid;
       ...
       private static CellInfoManager mCellInstance = null;
       ...
       public CellInfoManager(Context paramContext) {
              ...
              logger = Logger.getLogger(CellInfoManager.class);
       }
       public String imei(){
    	   return this.imei;
       }
       ...
       public JSONArray neighborCellInfo() {
           ...
           while (true) {
                  ...
                  if ((i2 <= 0) || (i2 == 65535))
                         continue;
                  int i3 = localNeighboringCellInfo.getLac();
                  int i4 = localNeighboringCellInfo.getRssi();
                  i4 = -113 + 2 * i4; // convert into dbm unit
                  int i5 = localNeighboringCellInfo.getNetworkType();
                  JSONObject jsonObject = new JSONObject();
                  try{
                	  jsonObject.put("cid", i2);
                	  jsonObject.put("lac", i3);
                	  jsonObject.put("dbm", i4);
                	  jsonObject.put("type", i5);
                  } catch(JSONException ex){
                	  jsonObject = null;
                	  logger.error("CellInfoManager: " + ex.getMessage());
                  }
       ...
       public abstract void onCellChanged();
              ...
              if (nPhoneType == 1 && cellLocation instanceof GsmCellLocation) {
                     ...
                     if (nGSMCID > 0) {
                            if (nGSMCID != 65535) {
                                   ...
                                   if(this.cid != oldCid || this.lac != oldLac){
                                	   onCellChanged();
                                   }
                            }
                     }
       ...
       class CellInfoListener extends PhoneStateListener {
              ...
              public void onCellLocationChanged(CellLocation paramCellLocation) {
                     ...
                     CellInfoManager.this.update();
              }
              public void onSignalStrengthChanged(int paramInt) {
                     CellInfoManager.this.asu = paramInt;
                     logger.info("CellInfoManager: onSignalStrengthChanged:" + String.valueOf(paramInt));
              }
       }
} 
